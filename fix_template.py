"""Fix order_express.html to prevent page reload and remove processed orders from DOM"""

content = '''{% extends "kho/base_kho.html" %}
{% load static %}
{% load humanize %}
...
# Write to file
with open(r'd:\giadungplus\giadungplus-1\kho\templates\kho\orders\order_express_v2.html', 'w', encoding='utf-8') as f:
    f.write(content)
